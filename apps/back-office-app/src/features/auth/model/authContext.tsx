/**
 * Auth feature — Back Office application (single-role).
 *
...
const APP_ROLE: UserRole = 'back_office';

/**
 * Demo user for the back-office role — kept only for the deprecated
 * `selectRole` shim. Real sessions come from the backend.
 */
const MOCK_USER: MockUser = {
  id: 'c1d2e3f4-5a6b-7c8d-9e0f-123456789abc',
  name: 'Back Office',
  nameAr: 'المكتب الخلفي',
